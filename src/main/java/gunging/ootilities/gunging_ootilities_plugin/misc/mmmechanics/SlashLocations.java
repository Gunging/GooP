...
public class SlashLocations<T> extends TCPEffect {
    ...
    public boolean horizontal, randomPoints;
    ...
    @NotNull public ArrayList<T> playParticleSlashEffect(SkillMetadata data, AbstractLocation target, Object... funnies) {
        ...
        if (slashTicks <= 0) {
            ...
            for (double i = 0; i < pointsTotal; i++) {
                ...
                // Generate all points
                T r = slashGen(random, data, target, targetLocationCopy.clone(), circumference, pointsTotal, fraction, skewed, b, i, funnies);
            ...
            (new BukkitRunnable() {
                public void run() {
                    ...
                    for (double I = 0; I < simultaneous; I++) {
                        ...
                        // Generate all points
                        slashGen(random, data, target, targetLocationCopy.clone(), circumference, pointsTotal, fraction, skewed, b, i.getValue(), funnies);
    ...
    @Nullable public T slashGen(@NotNull Random random, @NotNull SkillMetadata data, @NotNull AbstractLocation target, @NotNull AbstractLocation sourceLocation, double circumference, double pointsTotal, double fraction, double skewed, double b, double i, Object... funnies) {
        ...
        AbstractVector slashDelta = transform(data, target, x, y, z);
